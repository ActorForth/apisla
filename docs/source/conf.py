...
project = 'apisla'
copyright = 'The apisla authors'
author = 'The apisla authors'
...
latex_documents = [
    (master_doc, 'apisla.tex', 'Trio Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'apisla', 'apisla Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'apisla', 'apisla Documentation',
     author, 'apisla', 'SLAs for APIs managing load & performance guarantees.',
     'Miscellaneous'),
]
